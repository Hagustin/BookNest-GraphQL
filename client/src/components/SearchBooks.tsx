...
import { SAVE_BOOK } from '../utils/mutations';  // Assuming this mutation is defined in 'mutations.ts'
...
const SearchBooks = () => {
  ...
  const handleSearchSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(`/api/google-books?q=${encodeURIComponent(searchInput)}`);
